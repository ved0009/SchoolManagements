...
export const MENU_ITEMS_TEACHER: NbMenuItem[] = [
  // {
  //   title: "SCRM",
  //   icon: "shopping-cart-outline",
  //   link: "/scrm/admin/dashboard",
...

  {
    ...
    children: [
      {
        title: "All Students",
        link: "/scrm/Teacher/Students/allstudent",
        icon: "list-outline",
      },
      {
        title: "Add new",
        link: "/scrm/Teacher/Students/newstudent",
        icon: "person-add-outline",
      },

      {
        title: "Manage Families",
        link: "/scrm/Teacher/Students/managefamilies",
        icon: "people-outline",
      },
      {
        title: "Active / Inactive",
        link: "/scrm/Teacher/Students/activeinactive",
        icon: "person-done-outline",
      },
      {
        title: "Admission Letter",
        link: "/scrm/Teacher/Students/admissionletter",
        icon: "file-text-outline",
      },
      {
        title: "Student ID Card",
        link: "/scrm/Teacher/Students/studentcard",
        icon: "person-outline",
      },
      {
        title: "Print Basic List",
        link: "/scrm/Teacher/Students/printbasiclist",
        icon: "download-outline",
      },
      {
        title: "Promote Students",
        link: "/scrm/Teacher/Students/promotestudent",
        icon: "trending-up-outline",
      },
    ],
  },
  {
    ...
    children: [
      {
        title: "All Class",
        link: "/scrm/Teacher/Class/allclass",
        icon: "list-outline",
      },
      {
        title: "New Class",
        link: "/scrm/Teacher/Class/newclass",
        icon: "person-add-outline",
      },
    ],
  },
